...
<style type="text/css">
  .dataTables_filter {
   ...
   <div class="form-group">
     <h3>Pencarian Buku :</h3> <input type="text" class="form-control" id="searchbox">
<br>
   </div>
  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <td><?php echo $op['stok']-$op['pinjam']; ?></td>
                <td><?php $kategori=$op['id_kategori'];
                    foreach ($data_kategori ->result_array()  as $op2) {
                      if($op2['id_kategori']==$kategori){
                          echo $op2['no_rak'];
...
<?php
  ...
  <div class="box-footer">
    Menampilkan daftar buku, untuk melihat detail buku klik tombol <b>+</b>, Lakukan pencarian Buku pada form <b>Pencarian Buku</b> .
  </div><!-- box-footer -->
</div><!-- /.box --></ul>
