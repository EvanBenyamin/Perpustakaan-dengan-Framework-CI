  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <td><?php echo $op['id_penerbit']; ?></td>
                <td><?php echo $op['id_pengarang'];?></td>
                <td><?php echo $op['stok']-$op['pinjam'] ?></td>
                <td><?php echo $op['pinjam'] ?></td>
                <td><?php $kategori=$op['id_kategori'];
                    foreach ($data_kategori ->result_array()  as $op2) {
                      if($op2['id_kategori']==$kategori){
                          echo $op2['no_rak'];
                ...
                <td><img src="<?php echo base_url();?>/gambar_buku/<?php echo $op['foto'];?>" style="width: 100px;height: 100px;"></td>
                <td>
                <?php echo 
                    '<div class="btn-group">
