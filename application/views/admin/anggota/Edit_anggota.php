	...
	<form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>admin/Anggota/update" role="form">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" value="<?php echo $anggota['nis'];?>"  class="form-control" name="nis" placeholder="Nis" >
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                 <label class="col-sm-2 control-label">Agama</label>
                  <div class="col-sm-5">
                     ...
                     <option value="Khatolik" <?php echo $anggota['agama']=="Khatolik" ? 'Selected':''; ?>>Khatolik</option>
