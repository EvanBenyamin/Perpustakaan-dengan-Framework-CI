...
<body onload="window.print();" style="margin-top: 10px;">
  ...
  <table cellspacing="0"  width="50%">
   <tr><td colspan="3"><center><h4><b>Tanda Terima Pengembalian Buku</b></h4></center></td></tr>
    <tr>
   ...
   <tr>
    ...
    <tr>
      <td width="25%"><h5><b> Tanggal dikembali</b> </h5></td>
      <td> <h5><b>:</b></h5></td>
      <td><h5><b><?php
                $date=date("d-M-Y",strtotime($a->tgl_dikembalikan));
                echo $date;
              ?>
      </b></h5>
        </td>
     ...
     <tr>
      <td width="25%"><h5><b> Denda</b> </h5></td>
      <td> <h5><b>:</b></h5></td>
      <td><h5><b>Rp <?php echo number_format($a->denda); ?>
      </b></h5>
        </td>
    </tr> 
   </table>
 <?php } ?>
 <center><h4><b>Buku Yang Dikembalikan</b></h4></center>
