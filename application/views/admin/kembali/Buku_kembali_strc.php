...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <div class="box-body">
     <a href="<?php echo base_url('admin/Report/kembali/'.$_GET["id_pinjam"].''); ?>" style="float: right;" target="_blank"  class="btn btn-warning" role="button" data-toggle="tooltip" title="Cetak Pengembalian"><i class="fa fa-print"></i> Cetak Pengembalian</a>
