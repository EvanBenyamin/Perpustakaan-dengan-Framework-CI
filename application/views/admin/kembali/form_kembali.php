...
<div class="box box-solid box-primary">
  ...
  <div class="form-group"></div>
	<form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>admin/Kembali/Kembalikan/<?php echo $data_pinjam['id_pinjam'];?>" role="form" id="myForm">
              <div class="box-body">
              ...
              <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="date" value="<?php echo $data_pinjam['tgl_kembali'];?>" disabled="disabled" required="required" class="form-control" id="tglh">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    <input data-provide="datepicker" value="<?php echo date('m/d/Y'); ?>" class="bootstrap-datepicker" name="tgl_kembali" id='tglk'>
                  </div>
              ...
              <div class="col-md-12">
                ...
                <i>- Ceklis buku yang ingin dikembalikan</i>
                <table class="table table-bordered">
                  ...
                  foreach($detail_pinjam->result_array() as $d){ $no++; ?>
                   <tr>
                    ...
                    <td><input type="checkbox" name="det[]" id="idd" value="<?php echo $d['id_detail_pinjam']; ?>" onclick="cek();" onchange="cek();"></td>
                  </tr>
                  <?php } ?>
                </table>
              </div>
              ...
              <div class="col-sm-4">
                  <div class="btn-group">
                   ...
                   <div class="btn-group">
                   <button type="submit" class="btn btn-success" id="kemb" style="display: none;"><i class="fa fa-share"></i> Kembalikan</button>
                  </div>
              </div>
              <!-- /.box-footer -->
            </form>
