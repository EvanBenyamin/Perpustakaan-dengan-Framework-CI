...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <div class="box-body">
     <a href="<?php echo base_url('admin/Report/kembali/'.$this->uri->segment(4).''); ?>" style="float: right;" target="_blank"  class="btn btn-warning" role="button" data-toggle="tooltip" title="Cetak Pengembalian"><i class="fa fa-print"></i> Cetak Pengembalian</a>
