...
|---------------------------------------------------------|
-->
<body class="hold-transition skin-purple sidebar-mini" onload="getlama()">
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>admin/Home"" class="logo">
      ...
      <span class="logo-mini">PG2</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>E-lib</b>SMA SEJAHTERA 1 DEPOK</span>
    </a>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="header">Peminjaman</li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a target="_blank" href="<?php echo base_url(); ?>admin/Report/buku"><i class="fa fa-files-o"></i>Laporan Data Buku</a></li>
            <li><a target="_blank" href="<?php echo base_url(); ?>admin/Report/anggota"><i class="fa fa-files-o"></i>Laporan Data Anggota</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Report/peminjaman_hari"><i class="fa fa-files-o"></i>Peminjaman perHarian</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Report/peminjaman_bulan"><i class="fa fa-files-o"></i>Peminjaman perBulan</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Report/peminjaman_tahun"><i class="fa fa-files-o"></i>Peminjaman perTahun</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Report/peminjaman_range"><i class="fa fa-files-o"></i>Peminjaman Range TGL</a></li>
               <li><a href="<?php echo base_url(); ?>admin/Report/dikembalikan_hari"><i class="fa fa-files-o"></i>Dikembalikan perHarian</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Report/dikembalikan_bulan"><i class="fa fa-files-o"></i>Dikembalikan perBulan</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Report/dikembalikan_tahun"><i class="fa fa-files-o"></i>Dikembalikan perTahun</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Report/dikembalikan_range"><i class="fa fa-files-o"></i>Dikembalikan Range TGL</a></li>
          </ul>
        </li>
        <li class="header">Denda</li>
        <li><a href="<?php echo base_url();?>admin/Denda"><i class="fa fa-usd"></i> <span>Master Denda</span></a></li>
        <li class="header">Buku Tamu</li>
        <li><a href="<?php echo base_url();?>admin/Tamu"><i class="fa fa-users"></i> <span>Data Tamu</span></a></li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>STMIK JAYANUSA &copy; 2020</strong> 
  </footer>
...
<script>
 ...
 function getlama() {
    ...
    var firstDate = new Date($("#tglh").val());
    var secondDate = new Date($("#tglk").val());
    var diffDays = Math.round(Math.round((secondDate.getTime() - firstDate.getTime()) / (oneDay)));
    var lama= diffDays;

    if(lama > 0){
     $("#alr").show();
      $('#pes').html("Terlambat : " + lama + " Hari");
    }

  }
function cek() {

     var cekbok = $('input[name=det]:checked');
    if(cekbok){
      $("#kemb").show();
    }
  }
