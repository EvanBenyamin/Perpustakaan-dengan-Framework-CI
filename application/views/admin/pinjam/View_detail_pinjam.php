...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group">
   <a href="<?php echo base_url(); ?>admin/Pinjam/createdet"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Data Detail Stok  Buku"><i class="fa fa-plus"></i>Tambah Buku Dipinjam</a>

 </div>
   <a href="<?php echo base_url('admin/Report/index/'.$this->uri->segment('4').''); ?>" style="float: right;" target="_blank"  class="btn btn-warning" role="button" data-toggle="tooltip" title="Cetak peminjaman"><i class="fa fa-print"></i> Cetak Peminjaman</a>
   <!--div class="btn-group">
  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <td><?php echo $op['stt'];?></td>
                <td>     
                <?php echo 
                    '<div class="btn-group">
                    <span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'admin/Pinjam/delete_det/?id_detail_pinjam='.$op['id_detail_pinjam'].'">
