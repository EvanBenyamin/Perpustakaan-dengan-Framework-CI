  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <?php echo 
                    '<div class="btn-group">
                    <a href="'.base_url().'admin/Pinjam/View_dt_pinjam/?id_pinjam='.$op['id_pinjam'].'" class="btn btn-info" role="button" data-toggle="tooltip" title="Buku Dipinjam"><i class="fa fa-list"></i></a>&nbsp
                    </div>';
                    if($op['status']==0)
                    {
                     echo 
                    ...
                    {                 
                     echo 
                     '&nbsp <a href="'.base_url().'admin/Kembali/Hilang/?id_pinjam='.$op['id_pinjam'].'" class="btn btn-danger" role="button" data-toggle="tooltip" title="Hilang"><i class="fa fa-money"></i></a>';
                    }
                    echo
                '</td>
            </tr>';?>
